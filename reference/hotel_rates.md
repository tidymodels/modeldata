...
a predictor for the historical daily rates. See the `hotel_rates.R` file
in the `data-raw` directory of the package to understand other filters
used when creating this version of the data.

The `agent` and `company` fields were changed from random characters to
use a set of random names.
