...
- Added a new data that is simulated (but based on real data) that will
  used at posit::conf 2026.
...
- A simulation functions were added:
  ...
  - [`sim_logistic()`](https://modeldata.tidymodels.org/reference/sim_classification.md)
    and
    [`sim_multinomial()`](https://modeldata.tidymodels.org/reference/sim_classification.md)
    were added.

  - A method for Hooker (2004) was added for
    [`sim_regression()`](https://modeldata.tidymodels.org/reference/sim_classification.md).
